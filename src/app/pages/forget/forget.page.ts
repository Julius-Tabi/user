...
export class ForgetPage implements OnInit {
   ...
   email: any;
  constructor(
    private auth: SignInSignUpService, private route: Router,public accountServices: SignInSignUpService,private formBuilder:FormBuilder, private accountService: SignInSignUpService,private router: Router,public nav: NavController,
